...
/** @typedef {import("./utils/rule").Node<"Identifier">} Identifier */
...
module.exports = rule({
    ...
    create(context) {
         ...
         * @param {Identifier} node The node to report.
         * @returns {void}
         * @private
         */
        ...
        return {
            ...
            Identifier(node) {
                ...
                if (node.parent.type === "MemberExpression") {
                    ...
                    } else if (effectiveParent.type === "AssignmentExpression" && nameIsUnderscored && (effectiveParent.right.type !== "MemberExpression" || effectiveParent.left.type === "MemberExpression" && effectiveParent.left.property.type === "Identifier" && effectiveParent.left.property.name === node.name)) {
                        report(node);
                    }
