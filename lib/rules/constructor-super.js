...
/** @typedef {import("./utils/rule").Node} Node */
/** @typedef {import("./utils/rule").Node<"CallExpression">} CallExpression */
/** @typedef {import("./utils/rule").Node<"ReturnStatement">} ReturnStatement */
/** @typedef {Extract<Node, { type: "MethodDefinition"; kind: "constructor" }>} MethodDefinitionConstructor */
 ...
 * @property {CallExpression[]} validNodes The valid `super()` nodes, but can be invalid if the code path was looped.
 */
...
module.exports = rule({
    ...
    create(context) {
        ...
        return {
             ...
             * @param {CallExpression} node - A CallExpression node to check.
             * @returns {void}
             */
             ...
             * @param {ReturnStatement} node - A ReturnStatement node to check.
             * @returns {void}
             */
