...
export interface BigIntLiteral extends Def.Node<"BigIntLiteral", ASTDefinition> {}
...
export interface ImportExpression extends Def.Node<"ImportExpression", ASTDefinition> {}
