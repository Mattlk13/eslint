...
/** @typedef {import("../../lib/rules/utils/rule").Node} Node */
/** @typedef {import("../../lib/rules/utils/rule").Node<"Program">} Program */
/** @typedef {import("../../lib/rules/utils/rule").Node<"ObjectExpression">} ObjectExpression */
/** @typedef {import("../../lib/rules/utils/rule").Node<"Property">} Property */
 ...
 * @param {Node} node The node. This may be ObjectExpression node.
 * @returns {Property | null} The Property node or null if not found.
 */
 ...
 *
 * @param {ObjectExpression} exportsNode ObjectExpression node that the rule exports.
 * @returns {Property | null} The `meta` Property node or null if not found.
 */
 ...
 *
 * @param {Property} metaPropertyNode The `meta` ObjectExpression for this rule.
 ...
 *
 * @param {Node} node node that the rule exports.
 * @returns {node is ObjectExpression} `true` if the exported node is the correct format for a rule definition
 */
